package seunghee._혼자_공부하는_자바._14_입출력_스트림._02_보조_스트림.ex05;
...
public class ObjectStreamExample {
	...
	public static void writeList() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(FilePath.path + "/ex05/text.txt");
	...
	public static List<Board> readList() throws Exception {
		FileInputStream fis = new FileInputStream(FilePath.path + "/ex05/text.txt");
